    ...
    def locate_ip(self, ip):
        ...
        while record_max - record_min >= 0:
            ...
            if nip < minip:
                ...
                tmp_list = [str(minip), str(maxip), addr[0], addr[1], addr[2], addr[3], addr[4], addr[5], addr[6], _to_str(bd_lon), _to_str(bd_lat),
                        _to_str(wgs_lon), _to_str(wgs_lat), _to_str(radius), _to_str(scene), _to_str(accuracy), _to_str(owner)]
                res_list = []
